...
<head>
    ...
    <?php wp_head(); ?>
    <script>
        // Đảm bảo jQuery được load và wrap các script trong document ready
        jQuery(document).ready(function($) {
            // Fix cho Astra theme navigation
            $(document).on("click", ".main-header-bar-navigation a", function() {
                if ($("body").hasClass("ast-main-header-nav-open")) {
                    $(".main-header-menu-toggle.toggled").removeClass("toggled");
                    $(".main-header-bar-navigation.toggle-on").removeClass("toggle-on").css("display", "");
